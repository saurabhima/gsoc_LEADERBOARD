...
def outgoing_mail_process(donor_email,contact_person,contact_date,contact_time,salutation,
    ...
    subject_line='Donation request from SphinxCapt Project (TrackCode#'+mail_code+')'
    msg_body=salutation+'\n\n'+main_body+'\n\n'+closing+'\n\n'+signature+'\n\n'+footer
    draft_message = create_message('SphinxCapt Mail', donor_email,subject_line,msg_body)
